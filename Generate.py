...
def generateAsciiArray(specifiedIndex): # Returns a integer based on the current user's time this is between the range of 47 and 126 which is used as common ascii characters
    ...
    for i in range(32): # Generates a 32 character long randomized password which will be shortened when the user specifies how long they want their password
        ...
        passwordArrayIndexed = passwordArray[specifiedIndex]
    return passwordArrayIndexed # Returns the final password